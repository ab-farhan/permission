        ...
        <div class="col-lg-10 grid-margin stretch-card offset-lg-1">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-title">Edit CRM</h6>
                    <hr class="my-2 mb-4">
                    <form class="forms-sample" method="POST" action="{{ route('admin.crm.update',[$crm->id]) }}" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class=" col-lg-6 mb-3">
                                <label for="name" class="form-label"> Name</label>
                                <input type="text" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}"
                                    name="name" value="{{old('name') ?? $crm->name }}" id="name" autocomplete="off"
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="email" required
                                    ...
                                    value="{{old('email') ?? $crm->email }}" id="email" autocomplete="off"
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input type="phone" maxlength="11" required
                                    ...
                                    value="{{old('phone') ?? $crm->phone }}" id="email" autocomplete="off" placeholder="01xxxxxxxxx">
                                @if ($errors->has('phone'))
                                    <label id="name-error" class="error invalid-feedback"
                            ...
                            <div class="col-lg-6 mb-3">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select {{ $errors->has('role') ? ' is-invalid' : '' }}" id="role" name="role">
                                        <option disabled="">Select Crm</option>
                                        @foreach ($roles as $role)

                                        <option value="{{$role->id}}" {{ $crm->role_id == $role->id ? "selected" : "" }}>{{$role->name}}</option>
                                        @endforeach
